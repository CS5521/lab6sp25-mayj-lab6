...
int main() {
  ...
  10:	e8 18 04 00 00       	call   42d <fkc>
  ...
  21:	c7 44 24 04 e4 08 00 	movl   $0x8e4,0x4(%esp)
  28:	00 
  29:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  30:	e8 e0 04 00 00       	call   515 <printf>
  
  //Parent process calls fork twice
  //Child process do nothing other than exit
  if (fork() == 0) exit();
  35:	e8 43 03 00 00       	call   37d <fork>
  3a:	85 c0                	test   %eax,%eax
  3c:	75 05                	jne    43 <main+0x43>
  3e:	e8 42 03 00 00       	call   385 <exit>
  if (fork() == 0) exit();
  43:	e8 35 03 00 00       	call   37d <fork>
  48:	85 c0                	test   %eax,%eax
  4a:	75 05                	jne    51 <main+0x51>
  4c:	e8 34 03 00 00       	call   385 <exit>

  
  //The parent process calls wait twice
  //To reap the two child processes that were created.
  wait();
  51:	e8 37 03 00 00       	call   38d <wait>
  wait();
  56:	e8 32 03 00 00       	call   38d <wait>


  //Call fkc again
  after = fkc(1);
  5b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  62:	e8 c6 03 00 00       	call   42d <fkc>
  67:	89 44 24 18          	mov    %eax,0x18(%esp)
  printf(1, "number of forks after two more forks: %d\n", after);
  6b:	8b 44 24 18          	mov    0x18(%esp),%eax
  6f:	89 44 24 08          	mov    %eax,0x8(%esp)
  73:	c7 44 24 04 10 09 00 	movl   $0x910,0x4(%esp)
  7a:	00 
  7b:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  82:	e8 8e 04 00 00       	call   515 <printf>
  
  //Testing clean fkc
  cleaned = fkc(0);
  87:	c7 04 24 00 00 00 00 	movl   $0x0,(%esp)
  8e:	e8 9a 03 00 00       	call   42d <fkc>
  93:	89 44 24 14          	mov    %eax,0x14(%esp)
  printf(1, "number of forks after fork count cleared: %d\n", cleaned);
  97:	8b 44 24 14          	mov    0x14(%esp),%eax
  9b:	89 44 24 08          	mov    %eax,0x8(%esp)
  9f:	c7 44 24 04 3c 09 00 	movl   $0x93c,0x4(%esp)
  a6:	00 
  a7:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  ae:	e8 62 04 00 00       	call   515 <printf>
  
  //Call fkc after forking three times
  if (fork() == 0) exit();
  b3:	e8 c5 02 00 00       	call   37d <fork>
  b8:	85 c0                	test   %eax,%eax
  ba:	75 05                	jne    c1 <main+0xc1>
  bc:	e8 c4 02 00 00       	call   385 <exit>
  if (fork() == 0) exit();
  c1:	e8 b7 02 00 00       	call   37d <fork>
  c6:	85 c0                	test   %eax,%eax
  c8:	75 05                	jne    cf <main+0xcf>
  ca:	e8 b6 02 00 00       	call   385 <exit>
  if (fork() == 0) exit();
  cf:	e8 a9 02 00 00       	call   37d <fork>
  d4:	85 c0                	test   %eax,%eax
  d6:	75 05                	jne    dd <main+0xdd>
  d8:	e8 a8 02 00 00       	call   385 <exit>

  //Reap all the child processes to avoid zombies
  wait();
  dd:	e8 ab 02 00 00       	call   38d <wait>
  wait();
  e2:	e8 a6 02 00 00       	call   38d <wait>
  wait();
  e7:	e8 a1 02 00 00       	call   38d <wait>

  //Testing three forks
  thirdTest = fkc(1);
  ec:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  f3:	e8 35 03 00 00       	call   42d <fkc>
  f8:	89 44 24 10          	mov    %eax,0x10(%esp)
  printf(1, "number of forks after three more forks: %d\n", thirdTest);
  fc:	8b 44 24 10          	mov    0x10(%esp),%eax
 100:	89 44 24 08          	mov    %eax,0x8(%esp)
 104:	c7 44 24 04 6c 09 00 	movl   $0x96c,0x4(%esp)
 10b:	00 
 10c:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
 113:	e8 fd 03 00 00       	call   515 <printf>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4ae:	0f b6 80 e4 0b 00 00 	movzbl 0xbe4(%eax),%eax
...
printf(int fd, const char *fmt, ...)
{
 ...
 60b:	75 09                	jne    616 <printf+0x101>
          s = "(null)";
 60d:	c7 45 f4 98 09 00 00 	movl   $0x998,-0xc(%ebp)
        while(*s != 0){
...
free(void *ap)
{
 ...
 6d7:	a1 00 0c 00 00       	mov    0xc00,%eax
 ...
 7a2:	a3 00 0c 00 00       	mov    %eax,0xc00
}
 7a7:	c9                   	leave  
 7a8:	c3                   	ret    
...
morecore(uint nu)
{
 ...
 7f5:	e8 ce fe ff ff       	call   6c8 <free>
  return freep;
 7fa:	a1 00 0c 00 00       	mov    0xc00,%eax
}
 7ff:	c9                   	leave  
 800:	c3                   	ret    
...
malloc(uint nbytes)
{
 ...
 813:	89 45 ec             	mov    %eax,-0x14(%ebp)
  if((prevp = freep) == 0){
 816:	a1 00 0c 00 00       	mov    0xc00,%eax
 81b:	89 45 f0             	mov    %eax,-0x10(%ebp)
 81e:	83 7d f0 00          	cmpl   $0x0,-0x10(%ebp)
 822:	75 23                	jne    847 <malloc+0x46>
    base.s.ptr = freep = prevp = &base;
 824:	c7 45 f0 f8 0b 00 00 	movl   $0xbf8,-0x10(%ebp)
 82b:	8b 45 f0             	mov    -0x10(%ebp),%eax
 82e:	a3 00 0c 00 00       	mov    %eax,0xc00
 833:	a1 00 0c 00 00       	mov    0xc00,%eax
 838:	a3 f8 0b 00 00       	mov    %eax,0xbf8
    base.s.size = 0;
 83d:	c7 05 fc 0b 00 00 00 	movl   $0x0,0xbfc
 844:	00 00 00 
  }
 ...
 89a:	a3 00 0c 00 00       	mov    %eax,0xc00
      return (void*)(p + 1);
 ...
 8a5:	eb 38                	jmp    8df <malloc+0xde>
    ...
    if(p == freep)
 8a7:	a1 00 0c 00 00       	mov    0xc00,%eax
